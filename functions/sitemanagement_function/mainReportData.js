...
/**
 * Same STATUS rules as Reports (`Mainreport.js` getStatusLabel), except explicit
 * Approved / Rejected on the Statutory overlay still count even if no draft file is stored.
 */
function getMainReportStatusLabel(row) {
  ...
  if (!rowHasStoredDraft(row)) return 'Yet to Complete';
